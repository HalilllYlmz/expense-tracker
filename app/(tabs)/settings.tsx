...
export default function SettingsScreen() {
  ...
  const handleExport = async () => {
    ...
    try {
      // @ts-ignore (Tip hatası verirse susturmak için)
      const directory =
      ...
      await FileSystem.writeAsStringAsync(fileUri, jsonData, {
        encoding: "utf8", // String olarak utf8
      });
    ...
    >
      <View
        className={`w-10 h-10 rounded-full items-center justify-center mr-4 ${
          isDestructive ? "bg-red-900/30" : "bg-gray-800"
        }`}
      >
        <Ionicons
          name={icon}
  ...
  return (
    <View className="flex-1 bg-gray-950 pt-16 px-4">
      ...
      <SettingItem
        ...
        subtitle="Tüm harcamaları JSON olarak indir"
